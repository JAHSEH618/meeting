...
public final class GenericFileUploadSession {
    ...
    private GenericFileUploadSession(Builder builder) {
    ...
    public static GenericFileUploadSession create(
        String uploadId,
        String tenantId,
        String objectKey,
        String bucket,
    ...
    public GenericFileUploadSession markUploading(OffsetDateTime now) {
    ...
    public GenericFileUploadSession markCompleted(String fileId, OffsetDateTime now) {
        return copy(AudioUploadStatus.COMPLETED, requireText(fileId, "fileId"), now, abortedAt, now);
    }

    public GenericFileUploadSession markAborted(OffsetDateTime now) {
    ...
    public GenericFileUploadSession markExpired(OffsetDateTime now) {
    ...
    private GenericFileUploadSession copy(
    ...
    public static final class Builder {
        ...
        public GenericFileUploadSession build() { return new GenericFileUploadSession(this); }
    }
}
