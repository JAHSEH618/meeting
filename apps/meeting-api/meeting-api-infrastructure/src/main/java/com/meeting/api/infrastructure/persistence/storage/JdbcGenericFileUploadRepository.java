...
@Repository
public class JdbcGenericFileUploadRepository implements GenericFileUploadRepository {
    private final JdbcTemplate jdbcTemplate;

    public JdbcGenericFileUploadRepository(JdbcTemplate jdbcTemplate) {
    ...
    public GenericFileUploadSession saveSession(GenericFileUploadSession session) {
        jdbcTemplate.update(
            """
            INSERT INTO generic_file_upload_sessions (
              id, tenant_id, file_id, object_key, bucket, content_type,
    ...
    public GenericFileUploadPart savePart(GenericFileUploadPart part) {
        jdbcTemplate.update(
            """
            INSERT INTO generic_file_upload_parts (
              id, tenant_id, upload_id, part_number, part_sha256,
    ...
    public Optional<GenericFileUploadPart> findPart(String tenantId, String uploadId, int partNumber) {
        List<GenericFileUploadPart> parts = jdbcTemplate.query(
            """
            SELECT id, tenant_id, upload_id, part_number, part_sha256,
                   size_bytes, etag, upload_status, uploaded_at, created_at, updated_at
              FROM generic_file_upload_parts
    ...
    private GenericFileUploadSession mapSession(ResultSet rs, int rowNum) throws SQLException {
        return new GenericFileUploadSession.Builder()
    ...
    private GenericFileUploadPart mapPart(ResultSet rs, int rowNum) throws SQLException {
