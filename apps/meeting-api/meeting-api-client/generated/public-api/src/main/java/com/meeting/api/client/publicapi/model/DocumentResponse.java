...
public class DocumentResponse {
  ...
  public DocumentResponse success(@javax.annotation.Nonnull Boolean success) {
  ...
  public DocumentResponse data(@javax.annotation.Nonnull Document data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nonnull Document data) {
    this.data = data;
  }


  public DocumentResponse error(@javax.annotation.Nullable ErrorInfo error) {
    this.error = error;
    return this;
  }
  ...
  public DocumentResponse requestId(@javax.annotation.Nonnull String requestId) {
  ...
  public DocumentResponse traceId(@javax.annotation.Nonnull String traceId) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.success, documentResponse.success) &&
        Objects.equals(this.data, documentResponse.data) &&
        Objects.equals(this.error, documentResponse.error) &&
        Objects.equals(this.requestId, documentResponse.requestId) &&
        Objects.equals(this.traceId, documentResponse.traceId);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DocumentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DocumentResponse is not found in the empty JSON string", DocumentResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DocumentResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DocumentResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      Document.validateJsonElement(jsonObj.get("data"));
