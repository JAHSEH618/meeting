...
public class CreateFileUploadRequest {
  ...
  public CreateFileUploadRequest fileName(@javax.annotation.Nonnull String fileName) {
  ...
  public CreateFileUploadRequest contentType(@javax.annotation.Nonnull ContentTypeEnum contentType) {
  ...
  public CreateFileUploadRequest fileSizeBytes(@javax.annotation.Nonnull Long fileSizeBytes) {
  ...
  public CreateFileUploadRequest fileSha256(@javax.annotation.Nonnull String fileSha256) {
  ...
  public CreateFileUploadRequest partSizeBytes(@javax.annotation.Nullable Integer partSizeBytes) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fileName, createFileUploadRequest.fileName) &&
        Objects.equals(this.contentType, createFileUploadRequest.contentType) &&
        Objects.equals(this.fileSizeBytes, createFileUploadRequest.fileSizeBytes) &&
        Objects.equals(this.fileSha256, createFileUploadRequest.fileSha256) &&
        Objects.equals(this.partSizeBytes, createFileUploadRequest.partSizeBytes);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateFileUploadRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateFileUploadRequest is not found in the empty JSON string", CreateFileUploadRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateFileUploadRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateFileUploadRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
