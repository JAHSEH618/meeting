const ERROR_MESSAGES: Record<string, string> = {
  ...
  LEGAL_HOLD_NOT_FOUND: "法定保全不存在",
  LEGAL_HOLD_ALREADY_RELEASED: "法定保全已被释放",
  DELETION_JOB_BLOCKED_BY_LEGAL_HOLD: "删除任务被法定保全阻断",
  DELETION_JOB_ALREADY_FINISHED: "删除任务已结束",
  BREAK_GLASS_REQUEST_EXPIRED: "紧急访问申请已过期",
  BREAK_GLASS_INSUFFICIENT_APPROVERS: "紧急访问审批人数不足",
  BREAK_GLASS_SELF_APPROVAL_FORBIDDEN: "申请人不能审批自己的紧急访问申请",
  AUDIT_QUERY_TOO_BROAD: "审计查询时间窗超出 90 天上限",
